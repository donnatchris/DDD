...
Dans une architecture en couches traditionnelle, les dépendances vont généralement des couches supérieures vers les couches inférieures. Cependant, grâce à l’inversion de dépendance, le domaine et l’application peuvent définir des interfaces que l’infrastructure vient implémenter, afin que les règles métier ne dépendent pas des technologies utilisées. Ainsi il est plus simple de gérer les changements.
